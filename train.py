...
def prepare_dataloaders(fdir, n_gpu):
    trainset = ljdataset(fdir) #text, mel
...
if __name__ == '__main__':
    ...
    # path
    parser.add_argument('-d', '--data_dir', type = str, default = "/home/hschung/ecg/DeepLearningExamples/PyTorch/SpeechSynthesis/Tacotron2/LJSpeech-1.1/",
