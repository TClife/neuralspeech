...
from utils.audio import save_wav, inv_melspectrogram, melspectrogram
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--ckpt_pth', type = str, default = '/home/hschung/tts/neuralspeech/ckpt/ckpt_30000',
                        required = False, help = 'path to load checkpoints')
    parser.add_argument('-i', '--img_pth', type = str, default = '/home/hschung/tts/neuralspeech/alignment',
                        help = 'path to save images')
    parser.add_argument('-w', '--wav_pth', type = str, default = '/home/hschung/tts/neuralspeech/generated_wav',
                        help = 'path to save wavs')
    parser.add_argument('-n', '--npy_pth', type = str, default = '/home/hschung/tts/neuralspeech/mel',
                        help = 'path to save mels')
    parser.add_argument('-t', '--text', type = str, default = 'in being comparatively modern.',
