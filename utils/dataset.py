...
class ljdataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return text, mel #mel shape = [80, 223]
...
# What each of the returned values represent:
#     1. text_padded is all the texts padded to fit the length of the maximum text  
#     for text with input_lengths [117, 101, 54, 43], all texts are padded to length 117
#     2. mel_padded and gate_padded depends on the maximum length in output_lengths
#     which is 792 in this case, and therefore mel_padded has shape [bs, 80, 792] and gate_padded has shape [bs, 792]
